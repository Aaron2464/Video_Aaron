...
//
//public class xxx implements IMPlayer,MediaPlayer.OnBufferingUpdateListener,
...
//            mPlayer.setDisplay(display.getHolder());
//            mPlayer.start();
//            log("视频开始播放");
...
//
//    @Override
//    public void mPlay() throws MPlayerException {
//        if(!checkPlay()){
